...
#define LOG_TAG "android.hardware.power-service.RMX1851-libperfmgr"
...
int main() {
    LOG(INFO) << "RMX1851 Power HAL AIDL Service with Extension is starting.";
    ...
    LOG(INFO) << "RMX1851 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "RMX1851 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
